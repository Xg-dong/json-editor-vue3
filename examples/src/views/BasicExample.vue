          ...
          <el-card>
            ...
            <div class="controls">
              ...
              <el-row :gutter="10" class="mt-10">
                ...
                <el-col :span="12">
                  <el-select v-model="selectedSample" placeholder="选择示例数据" @change="loadSelectedSample">
                    <el-option
              ...
              <el-collapse v-model="activeCollapse" accordion>
                ...
                <el-collapse-item title="事件日志" name="events">
                  <div class="event-log">
                    ...
                    <el-button size="small" @click="clearEventLog" class="mt-10">清空日志</el-button>
                  </div>
                </el-collapse-item>
              </el-collapse>
            </div>
...
import { collectAllPaths } from 'json-editor-vue3/utils'
